package com.sih26003.smritisetu.voice.playback

import android.content.Context
import android.speech.tts.TextToSpeech
import com.google.gson.Gson
import com.sih26003.smritisetu.voice.packs.LanguagePack
...
class VoicePromptManager(private val context: Context) : TextToSpeech.OnInitListener {
    ...
    fun speak(text: String) {
        if (isTtsReady && text.isNotBlank()) {
            tts?.speak(text, TextToSpeech.QUEUE_FLUSH, null, "smritisetu_prompt_${System.currentTimeMillis()}")
        }
    }
