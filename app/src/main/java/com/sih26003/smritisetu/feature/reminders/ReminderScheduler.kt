...
import com.sih26003.smritisetu.MainActivity
import com.sih26003.smritisetu.R
...
class ReminderBroadcastReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        val title = intent.getStringExtra("reminder_title") ?: "স্মৃতিসেতু সোঁৱৰণী (SmritiSetu Reminder)"
        val type = intent.getStringExtra("reminder_type") ?: "MEDICINE"

        val channelId = "smritisetu_reminders"
