...
import com.sih26003.aasriti.feature.doctor.PdfReportGenerator
import com.sih26003.aasriti.feature.games.framework.GameId
import com.sih26003.aasriti.feature.games.framework.PerformanceCollector
...
class CoreEngineTests {
    ...
    fun testAdaptiveEngineAdjustments() {
        ...
        val eased = com.sih26003.aasriti.engine.adaptive.AdaptiveEngine.evaluateNextRound(
            currentLevel = 3,
            accuracy = 0.8f,
        ...
        val lowAcc = com.sih26003.aasriti.engine.adaptive.AdaptiveEngine.evaluateNextRound(
            currentLevel = 2,
            accuracy = 0.5f,
        ...
        val steppedUp = com.sih26003.aasriti.engine.adaptive.AdaptiveEngine.evaluateNextRound(
            currentLevel = 2,
            accuracy = 1.0f,
        ...
        val stable = com.sih26003.aasriti.engine.adaptive.AdaptiveEngine.evaluateNextRound(
            currentLevel = 2,
            accuracy = 0.85f,
    ...
    fun testTrendEngine7DayAggregation() {
        val sessions = listOf(
            com.sih26003.aasriti.domain.model.GameSession(
                id = "s1",
        ...
        val trend = com.sih26003.aasriti.engine.trend.TrendEngine.compute7DaySignals("AS-KAM-0042", sessions)
    ...
    fun testPriorityEngineTriageAlerts() {
        val testPatient = com.sih26003.aasriti.domain.model.Patient(
            id = "AS-KAM-0042",
        ...
        val doneReminders = listOf(
            com.sih26003.aasriti.domain.model.Reminder(
                id = "r1",
        ...
        // 1. Normal state
        val normalPriority = com.sih26003.aasriti.engine.priority.PriorityEngine.evaluateTodayPriority(
            patient = testPatient,
        ...
        val watchPriority = com.sih26003.aasriti.engine.priority.PriorityEngine.evaluateTodayPriority(
            patient = testPatient,
        ...
        val fallPriority = com.sih26003.aasriti.engine.priority.PriorityEngine.evaluateTodayPriority(
            patient = testPatient,
            reminders = doneReminders,
            recentSessions = emptyList(),
            recentLogs = fallLog
    ...
    fun testTrendEngineEmptyStateNoSyntheticData() {
        val trend = com.sih26003.aasriti.engine.trend.TrendEngine.compute7DaySignals("AS-KAM-0042", emptyList())
        assertEquals("AS-KAM-0042", trend.patientId)
    ...
    fun testCareLogPersistenceEntityToDomainMapping() {
        val entity = com.sih26003.aasriti.data.local.entities.CareLogEntity(
            id = "log-test-1",
            patientId = "AS-KAM-0042",
            authorRole = "CAREGIVER",
            category = "FALL",
        ...
        val domainLog = com.sih26003.aasriti.domain.model.CareLog(
            id = entity.id,
    ...
    fun testCareLogFallSeverityTriageMapping() {
        ...
        val priority = com.sih26003.aasriti.engine.priority.PriorityEngine.evaluateTodayPriority(
