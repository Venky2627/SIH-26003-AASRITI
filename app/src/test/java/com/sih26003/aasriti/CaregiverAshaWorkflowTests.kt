...
class CaregiverAshaWorkflowTests {
    ...
    fun testPriorityEngineWatchWhenHighHesitationInGameSession() {
        val highHesitationSession = com.sih26003.aasriti.domain.model.GameSession(
            id = "sess_hes",
            patientId = testPatient.id,
            gameId = "FLOWER_MATCH",
            difficultyLevel = 1,
    ...
    fun testGoldenSliceGameSessionTelemetryToCaregiverPriority() {
        ...
        val realSession = com.sih26003.aasriti.data.local.entities.GameSessionEntity(
            patientId = DemoPatientConfig.PATIENT_ID,
        ...
        val domainSession = com.sih26003.aasriti.domain.model.GameSession(
            id = realSession.id,
    ...
    fun testGoldenSliceHonestEmptyStateWhenNoGameSessionsExist() {
        val emptySessions: List<com.sih26003.aasriti.data.local.entities.GameSessionEntity> = emptyList()
